...
<#
 KiRo PC Diagnostic & Repair v4.0 GUI
 Windows 10/11
...
try {
    $wTitle = if ($Action) { "KiRo v4.0 - ALATI: $Action" } else { "KiRo PC Diagnostic & Repair v4.0" }
...
function Write-Header {
    ...
    Write-Host "            KiRo PC DIAGNOSTIC & REPAIR  v4.0 GUI" -ForegroundColor Cyan
    Write-Host "====================================================================" -ForegroundColor Cyan
